...
const EmployeeMonth = () => {
  ...
  return (
    <div className="bg-stretch-x bg-no-repeat bg-empofmon ">
      <img src={medal} alt="" className="w-52 h-52 mr-auto -mb-52" />
      <div className="px-4 sm:px-8 md:px-20 lg:px-32 xl:px-48 2xl:px-0 mx-auto max-w-1366 pt-16 font-for-para">
