...
const SideBar = () => {
  ...
  return (
    <div className=" lg:w-1/3 md:w-1/2 md:pl-6 lg:pl-8 xl:pl-12 flex flex-col md:ml-auto w-full md:mt-0">
      <div className="text-gray-2 text-xl font-bold bg-gray-200 mb-8">
        ...
        <Link to="/services">
          <h1 className="rounded-lg py-5 pl-8 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner">
            <span className="mx-0.5 sm:mx-4 md:mx-1 lg:mx-0.5 xl:mx-4">➔</span> Residential Security
          </h1>
        </Link>
        <Link to="/services">
          <h1 className="rounded-lg py-5 pl-8 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner">
            <span className="mx-0.5 sm:mx-4 md:mx-1 lg:mx-0.5 xl:mx-4">➔</span> Commercial Security
          </h1>
        </Link>
        <Link to="/services">
          <h1 className="rounded-lg py-5 pl-8 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner">
        ...
        <Link to="/jobs">
          <h1 className="rounded-lg py-5 pl-8 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner">
            <span className="mx-0.5 sm:mx-4 md:mx-1 lg:mx-0.5 xl:mx-4">➔</span> Employment
          </h1>
        </Link>
      </div>
      <div className="w-full flex flex-col items-center text-center mx-auto px-10 py-10 bg-gray-200 mt-24 mb-8">
        ...
        <a
          className="w-full text-2xl lg:text-base xl:text-2xl p-4 text-white font-bold hover:bg-white border-3 bg-red-1 border-red-1 hover:text-red-1 rounded-lg mt-10 sm:mt-0 shadow-button-shadow-2"
