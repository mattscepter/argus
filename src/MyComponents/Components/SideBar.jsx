...
const SideBar = () => {
  ...
  return (
    <div className=" lg:w-1/3 md:w-1/2 px-4 lg:px-0 lg:pl-8 xl:pl-10 flex flex-col md:ml-auto w-full md:mt-0">
      ...
      <form className="bg-gray-200 p-6" onSubmit={handleSubmit}>
        {showAlert.show ? (
        ...
        <button
          type="submit"
          className="w-full p-4 rounded-lg border text-white bg-red-700 hover:bg-white hover:text-red-700 hover:border-red-700"
        >
          SEND MESSAGE
        </button>
      </form>
