              ...
              <div className="h-full overflow-hidden ">
                ...
                <div className=" bg-white mx-3 md:mx-0 lg:mx-3">
                  <div className="border-r-4 border-l-4 border-client">
                    ...
                    <p className="leading-relaxed text-base text-gray-2 px-3 pt-3 pb-6">
                    Site surveillance, road flaggers, risk
                    assessment, loss prevention and
                    mobile patrols.
                    </p>
                  </div>
                  <div className="bg-client rounded-b-lg">
              ...
              <div className="h-full overflow-hidden ">
                ...
                <div className=" bg-white mx-3 md:mx-0 lg:mx-3">
                  <div className="border-r-4 border-l-4 border-client">
                    ...
                    <p className="leading-relaxed text-base text-gray-2 px-3 pt-3 pb-6">
                    Fire Route watch, valid permit enforcement and 
                    deterrent against invalid/improper parking.
                    </p>
                  </div>
                  <div className="bg-client rounded-b-lg">
                    <button className="w-full p-4 text-gray-2 font-bold bg-client hover:bg-red-1 hover:text-white rounded-lg hover:shadow-button-inner mb-auto"
              ...
              <div className="h-full overflow-hidden ">
                ...
                <div className=" bg-white mx-3 md:mx-0 lg:mx-3">
                  <div className="border-r-4 border-l-4 border-client">
                    ...
                    <p className="leading-relaxed text-base text-gray-2 px-3 pt-3 pb-6">
                    Peace of mind, theft deterrent, minimize
                    property damager and safeguard against trespassing.
                    </p>
                  </div>
                  <div className="bg-client rounded-b-lg">
                    <button className="w-full p-4 text-gray-2 font-bold bg-client hover:bg-red-1 hover:text-white rounded-lg hover:shadow-button-inner mb-auto"
              ...
              <div className="h-full overflow-hidden ">
                ...
                <div className=" bg-white mx-3 md:mx-0 lg:mx-3">
                  <div className="border-r-4 border-l-4 border-client">
                    ...
                    VIP Protection, closed-circuit security
                    feeds, preserve and protect life and property.
                    </p>
                  </div>
                  <div className="bg-client rounded-b-lg">
                    <button className="w-full p-4 text-gray-2 font-bold bg-client hover:bg-red-1 hover:text-white rounded-lg hover:shadow-button-inner mb-auto"
              ...
              <div className="h-full overflow-hidden ">
                ...
                <div className=" bg-white mx-3 md:mx-0 lg:mx-3">
                  <div className="border-r-4 border-l-4 border-client">
                    ...
                    <p className="leading-relaxed text-base text-gray-2 px-5 pt-3 pb-6">
                    Marked Vehicles with first air kits and a
                    patrol reporting system to document every visit.
                    </p>
                  </div>
                  <div className="bg-client rounded-b-lg">
                    <button className="w-full p-4 text-gray-2 font-bold bg-client hover:bg-red-1 hover:text-white rounded-lg hover:shadow-button-inner mb-auto"
              ...
              <div className="h-full overflow-hidden ">
                ...
                <div className=" bg-white mx-3 md:mx-0 lg:mx-3">
                  <div className="border-r-4 border-l-4 border-client">
                    ...
                    <p className="leading-relaxed text-base text-gray-2 px-5 pt-3 pb-6">
                    Access control, emergency response,
                    crowd control. complete threat and risk Assessment.
                    </p>
                  </div>
                  <div className="bg-client rounded-b-lg">
                    <button className="w-full p-4 text-gray-2 font-bold bg-client hover:bg-red-1 hover:text-white rounded-lg hover:shadow-button-inner mb-auto"
